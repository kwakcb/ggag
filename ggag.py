...
data = [
    ...
    ("유비대용량", "3/1", "C310"), ("유비대용량", "4/2", "C420"), ("유비대용량", "4/3", "C430"), ("유비대용량", "4/4", "C440"),
    ("유비대용량", "3/5", "C350"), ("유비대용량", "4/6", "C460"), ("유비대용량", "4/7", "C470"), ("유비대용량", "4/8", "C480"),
    ...
    ("동원소용량", "2/1", "J050"), ("동원소용량", "2/2", "J060"), ("유비소용량", "2/1", "J070"), ("동원소용량", "2/2", "J080"),
    ("동원소용량", "3/1", "J090"), ("동원소용량", "3/2", "J100"), ("동원소용량", "3/1", "J110"), ("동원소용량", "3/2", "J120"),
    ("동원소용량", "5/1", "J130"), ("동원소용량", "5/2", "J140"), ("동원소용량", "5/1", "J150"), ("동원소용량", "5/2", "J160"),
    ("동원소용량", "6/1", "J170"), ("동원소용량", "6/2", "J180"), ("동원소용량", "6/1", "J190"), ("동원소용량", "6/2", "J200"),
